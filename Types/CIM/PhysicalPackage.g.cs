...
public partial record class PhysicalPackage(ManagementObject ManagementObject) : PhysicalElement(ManagementObject)
{
    /// <summary>
    /// Depth of the physical package, in inches.
    /// </summary>
    public float? Depth => (float?)ManagementObject[nameof(Depth)];
    /// <summary>
    /// Height of the physical package, in inches.
    /// </summary>
    public float? Height => (float?)ManagementObject[nameof(Height)];
    /// <summary>
    ...
    /// </summary>
    public float? Weight => (float?)ManagementObject[nameof(Weight)];
    /// <summary>
    /// Width of the physical package, in inches.
    /// </summary>
    public float? Width => (float?)ManagementObject[nameof(Width)];
}
